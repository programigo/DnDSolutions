...
var HubConnection = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.sendPrivateMessage(this.handshakeProtocol.writeHandshakeRequest(handshakeRequest))];
                    case 2:
                        _a.sent();
    ...
    HubConnection.prototype.stream = function (methodName) {
        ...
        subject.cancelCallback = function () {
            ...
            return promiseQueue.then(function () {
                return _this.sendPrivateMessage(cancelMessage);
            });
        };
        ...
        promiseQueue = this.sendPrivateMessage(message)
            .catch(function (e) {
            subject.error(e);
            delete _this.callbacks[invocationDescriptor.invocationId];
        });
    ...
    HubConnection.prototype.sendPrivateMessage = function (message) {
        this.resetKeepAliveInterval();
    ...
    HubConnection.prototype.invoke = function (methodName) {
        ...
        var p = new Promise(function (resolve, reject) {
            ...
            _this.sendPrivateMessage(message)
                .catch(function (e) {
                reject(e);
                // invocationId will always have a value for a non-blocking invocation
                delete _this.callbacks[invocationDescriptor.invocationId];
        ...
        this.pingServerHandle = setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.sendPrivateMessage(this.cachedPingMessage)];
                    case 2:
                        _b.sent();
                        return [3 /*break*/, 4];
                    case 3:
...
/** @private */
function sendPrivateMessage(logger, transportName, httpClient, url, accessTokenFactory, content, logMessageContent) {
    return __awaiter(this, void 0, void 0, function () {
    ...
    LongPollingTransport.prototype.send = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, Object(_Utils__WEBPACK_IMPORTED_MODULE_4__["sendPrivateMessage"])(this.logger, "LongPolling", this.httpClient, this.url, this.accessTokenFactory, data, this.logMessageContent)];
            });
        });
    };
    ...
    ServerSentEventsTransport.prototype.send = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, Object(_Utils__WEBPACK_IMPORTED_MODULE_2__["sendPrivateMessage"])(this.logger, "SSE", this.httpClient, this.url, this.accessTokenFactory, data, this.logMessageContent)];
            });
        });
    };
